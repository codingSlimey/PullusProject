...
function Button({ action, color, title, icon, extraClass, isdisabled }) {
	return (
		<button
			...
			} py-4 px-10 flex disabled:cursor-not-allowed disabled:opacity-60  items-center disabled:bg-grey disabled:text-black/50 filter  md:text-base rounded-full shadow-xl  my-auto`}
		>
			{title}
