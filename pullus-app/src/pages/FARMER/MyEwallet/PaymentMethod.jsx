...
function PaymentMethod() {
	...
	const data = [
		{ title: 'Paystack', icon: <FaPaypal className='text-primary' /> },
		{
			title: 'Flutter Wave',
	...
	return (
		<div className='my-20 w-full  mx-3 md:mx-auto rounded-xl md:w-10/12  h-auto py-10 bg-white '>
			{display === 'second' && (
				<div className='w-full'>
					<div>
						<h1 className='text-primary font-bold text-2xl'>Top up Wallet </h1>
						<hr />
					</div>
					<div className='flex flex-col mx-3 justify-center items-center gap-3'>
						...
						{data.map((item, index) => {
							return (
								<div
									key={index}
									className=' shadow-xl bg-[#fff] border-none w-full md:w-1/2 flex items-center my-4 justify-between rounded-full px-5'
								>
									<label
										htmlFor='paystack'
